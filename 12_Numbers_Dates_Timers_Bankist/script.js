...
console.log(Math.sqrt(295));

console.log(8 ** (2 / 3));
console.log(Math.max(5, 18, 23, 11, 2));
console.log(Math.max(5, 18, "23", 11, 2));
console.log(Math.max(5, 18, "23px", 11, 2));
console.log(Math.min(5, 18, "3", 11, 2));
...
const randomInt = (min, max) => {
 return Math.trunc(Math.random() * (max - min) + 1) + min; // 0...1 -> 0... (max-min) -> min...max
  
};
console.log(randomInt(10, 20));

// Rouning integers
console.log(Math.trunc(23.7)); // removes decimal
